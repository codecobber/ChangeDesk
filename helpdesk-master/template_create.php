...
?>
        ...
        <?php include('includes/sidebarmenu.inc.php'); ?>
                      ...
                      <div><?php if(isset($mymessage)){echo $mymessage;} ?></div>
                        ...
                        */
                          ...
                          if($checkFlag == 0){
                            ...
                            $filesLoc = "./theme/helpdesk-master/dataSearch/cr/data.json";
                            ...
                            foreach ($decodeJson as $skey => $svalue) {
                             ...
                             if($existsFlag == 0){
                              ...
                              echo "<p class='success'>Ticket created</p>";
                              ...
                              echo "<p class='errorRed'>Ticket ID already exists</p>";
                             }
                          }
                          else{
                            echo "We have ERRORS - please contact the developer";
                          }
                      }
                ...
                <form id="ticketForm" method="post" action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']);?>">
                  ...
                  <input type="radio" name="status" value="2">Amber
