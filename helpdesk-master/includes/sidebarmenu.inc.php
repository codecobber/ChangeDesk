<div class="row" id="dashboardInfo">
   <div class="medium-2 columns shadowRight">
     ...
     <hr>
     <h4>Changes</h4>
     <p><a class="home" href="<?php echo get_site_url();?>"><i class="fas fa-home"></i> Home</a></p>
     <p>
     ...
     if(isset($userOnline) && $userOnline == "y"){
       if($page == 'index'){
        ...
        <p><a class="home" href="<?php echo get_site_url().'index.php?id=help'?>"><i class="fas fa-info-circle"></i> Help</a></p>
        </ul>
