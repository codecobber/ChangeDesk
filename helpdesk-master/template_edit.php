...
if(!isset($_REQUEST['t'])){
  ...
  elseif($_SESSION['pStatus'] == 'p2'){
    ...
    $gsDataPath = "./theme/helpdesk-master/dataSearch/cr/data.json";
  }
              ...
              <hr>
                      ...
                      if ($_SERVER["REQUEST_METHOD"] == "POST"){
                        ...
                        $ticketExists = 0;
                          ...
                          if (empty($_POST["nonimpact"])) {
                            $nonimpactErr = "Content required";
                            $checkFlag =1;
                          } else {
                            $nonimpact = test_input($_POST["nonimpact"]);
                          }
                          ...
                          if($checkFlag == 0){
                            ...
                            foreach ($decodeJson2 as $jkey => $jvalue) {
                              ...
                              elseif($jkey == $GLOBALS['recordKey'] && $ticketExists == 0) {
                                ...
                                echo "<p class='success'>Success - file updated</p>";
                              }
                            }


                            if($GLOBALS['ticketExists'] == 1){
                              echo "<p class='Sorry'>Sorry - that file ref already exists.</p>";
                            }
                            ...
                            echo "<p class='Sorry'>Sorry, file not updated.<br>Ensure all required fields are completed.</p>";
                          }
                      }
                ...
                <form id="ticketForm" method="post" action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']);?>">
                  ...
                  <input type="radio" name="status" <?php if (isset($status) && $status=="3") echo "checked";?> value="3">Amber
